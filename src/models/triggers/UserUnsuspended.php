...
class UserUnsuspended extends Trigger
{
    /**
     * @inheritDoc
     */
    ...
    {
        return \Craft::t('triggers', 'When a user is unsuspended');
    }
    ...
    {
        $_this = $this;
        Event::on(Users::class, Users::EVENT_AFTER_UNSUSPEND_USER, function (UserEvent $e) use ($_this) {
